...
public class OkHttpManage {
     ...
     * @param callBack
     */
    public void request(BaseOkHttpClient client, final ApiCallBack callBack) {
        if (callBack == null) {
     ...
     * @param result
     */
    private void sendonSuccessMessage(final ApiCallBack callBack, final Object result) {
     ...
     * @param e
     */
    private void sendonFailureMessage(final ApiCallBack callBack, final Call call, final IOException e) {
        mHnadler.post(new Runnable() {
            @Override
            public void run() {
     ...
     * @param code
     */
    private void sendonErrorMessage(final ApiCallBack callBack, final int code) {
        mHnadler.post(new Runnable() {
            @Override
            public void run() {
